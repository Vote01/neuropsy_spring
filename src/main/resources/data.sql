...
insert into client (name, email) values ('Соня', 's@mail.ru');
insert into client (name, email) values ('Влада', 'v@mail.ru');

insert into userr (email, password, fk_id,role) values ('s@mail.ru','pass','1','CLIENT');
insert into userr (email, password, fk_id,role) values ('v@mail.ru','pass','2','CLIENT');


insert into psychologist (name, lname, town, videocon, description, age, education, practice, registration, price, image) values ('Мария','Шурова', 'Выкса',true,'Ваш психолог, работаю с аутизмом и СДВГ', '1995-11-19', 'МГУ','2016-10-17','2023-05-04', 3000,'https://www.factroom.ru/wp-content/uploads/2018/04/Depositphotos_21186817_m-2015-1.jpg');
insert into psychologist (name, lname, town, videocon, description, age, education, practice, registration, price, image) values ('Павел','Дягтев', 'Муром',true,'Работаю с парами и семьями, а также с подростками', '1998-08-30', 'МГУ','2020-05-19','2022-11-01', 4500,'https://belissimma.ru/wp-content/uploads/2021/02/2-5.jpg');
